...
// Mapping from character to escape code.
// Taken from https://www.webpagefx.com/tools/emoji-cheat-sheet/ and 
...
// specified emoji does not exist, returns the empty string.
...
//parses a regular expression and returns, if successful, a Regexp object 
//that can be used to match against text. 
//Panics if the expression cannot be parsed.
var reg = regexp.MustCompile("(:\\w+:)")

// Emojify takes in a string with emojis specified in it, and returns
// a string with every emoji place holder replaced with it's unicode value
// (unless it could not be found, in which case it is blank).
func Emojify(emojis string) string {
